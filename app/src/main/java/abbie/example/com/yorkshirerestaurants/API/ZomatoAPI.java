...
public class ZomatoAPI {
    public interface ZomatoApiCalls {
        ...
        @GET("api/v2.1/search")
        Observable<Restaurant.RestaurantResults> getRestaurantsByCity(@Query("entity_id") String entity_id,
       ...
       /* @Headers("user-key: 81b9e0cc148b3fc6659c2b04a40fede5")
        ...
        Observable<Restaurant.RestaurantResults> getCuisineById(@Query("city_id") String city_id);*/
